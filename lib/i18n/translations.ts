...
export const translations = {
  es: {
    ...
    catalog: {
      ...
      loadErrorTitle: 'No pudimos cargar el inventario',
      loadErrorBody: 'Es un problema de nuestro lado, no de tu búsqueda. Probá de nuevo en un momento.',
      retry: 'Reintentar',
      viewResults: 'Ver',
      results: 'resultados',
  ...
  en: {
    ...
    catalog: {
      ...
      loadErrorTitle: "We couldn't load the inventory",
      loadErrorBody: "That's on our end, not your search. Try again in a moment.",
      retry: 'Try again',
      viewResults: 'View',
      results: 'results',
